...
DELIMITER //
	...
	BEGIN
		SELECT * FROM competitor JOIN competitor_joins_team using (id) JOIN team using (team_id) JOIN organization where competitor.id = cid && organization_id=team_organization;
	END;
